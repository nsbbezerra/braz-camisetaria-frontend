    ...
    <ContainerApp>
      ...
      <Container maxW="6xl" mt={10} mb={10}>
        ...
        >
          ...
          produção em larga escala, fazendo diversidade de aplicação nas peças,
          nossos profissionais em artes graficas estão prontos proporcionar
          lindas artes para nossos clientes, contamos também com grupo de
          consultores que ajuda o cliente a escolher a melhor peça para seu
          evento, empresa ou esporte.
        </Text>
        <Text
          style={{ textIndent: "30px" }}
          fontSize={"lg"}
        ...
        >
          ...
          mesmo, temos temor a palavra de Deus e trabalhamos acima de tuda para
          que o reino de Deus venha crescer na Terra e pedimos a Deus para que
          cada camiseta nossa sendo usada em qualquer lugar seja motivo de
          benção na vida de quem estiver usando.
        </Text>
      </Container>
      <ContainerNonFixed>
        <FooterApp />
